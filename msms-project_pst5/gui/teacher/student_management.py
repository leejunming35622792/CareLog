        ...
        with st.form("registration_form"):
            ...
            if submitted:
                ...
                if errors:
                    ...
                    new_student = manager.add_student(reg_name,username, password,  reg_instrument, reg_course)
                    if new_student:
                        # Add delay time
                        with st.spinner("Saving...", show_time=True):
                            time.sleep(1)
                        manager.save()
                        logging.info(f"Create New Student @{username}")
            ...
            if submitted:
                if update_id_list:
                    ...
                    if errors:  
                        ...
                        update_student = manager.update_student(username, password, update_id, update_name, update_instrument, update_course)
                        ...
                        if update_student:
                            ...
                            manager.save()
                            logging.info(f"Update Student @{username} Profile")
            ...
            if st.session_state.show_confirm:
                ...
                if confirm_delete:
                    ...
                    if delete:
                        ...
                        logging.info(f"Remove Student @{username}")
                        st.rerun()
